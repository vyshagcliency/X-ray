      ...
      <Page size="LETTER" style={styles.coverPage}>
        <View style={styles.ctaBox}>
          ...
          <Text style={styles.ctaBody}>
            What we run as a service is catching next month&apos;s overcharge
            before it compounds, across every channel you sell on, plus the
          ...
          <Text style={styles.catMeta}>calendly.com/vyshag-baslix/30min</Text>
        </View>
